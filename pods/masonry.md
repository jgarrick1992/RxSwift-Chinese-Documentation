...
**Masonry is in a bugfix only state as more developers will be moving to Swift. Going forward we recommend using** [**SnapKit**](https://github.com/SnapKit/SnapKit) **as it supports Swift and provides better type safety with a simpler API**.
...
| :--- | :--- |
| view.mas\_left | NSLayoutAttributeLeft |
| view.mas\_right | NSLayoutAttributeRight |
| view.mas\_top | NSLayoutAttributeTop |
| view.mas\_bottom | NSLayoutAttributeBottom |
| view.mas\_leading | NSLayoutAttributeLeading |
| view.mas\_trailing | NSLayoutAttributeTrailing |
| view.mas\_width | NSLayoutAttributeWidth |
| view.mas\_height | NSLayoutAttributeHeight |
| view.mas\_centerX | NSLayoutAttributeCenterX |
| view.mas\_centerY | NSLayoutAttributeCenterY |
| view.mas\_baseline | NSLayoutAttributeBaseline |
...
If you want to use masonry without all those pesky 'mas\_' prefixes. Add \#define MAS\_SHORTHAND to your prefix.pch before importing Masonry
